...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LoginRequestBody body = mapper.readValue(request.getReader(),
        ...
        if (connection.verifyLogin(body.userId, body.password)) {
            ...
            loginResponseBody = new LoginResponseBody("Login failed, userId and passcode do not exsit.", null, null);
